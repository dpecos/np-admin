...
<script> 
   ...
   YAHOO.util.Event.addListener(window, "load", function() {
      ...
      columnDefs = [ 
	   ...
	   dataSource = new YAHOO.util.DataSource("<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php?");
   ...
   function addRol() {
      ...
      if (formObject.rol_name.value.trim().length == 0)
         ...
         var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:addRolCallback});
      }
   }
   ...
   function deleteRolsConfirm(list) {
      ...
      var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:deleteRolsCallback}, postdata);
   }
...
YAHOO.extend(DDList, YAHOO.util.DDProxy, {
   ...
   function recoverDataUsersLists(rolId, rolName) {
      ...
      emptyList("unassigned_users");
      emptyList("assigned_users");
      var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:userListCallback, argument:["unassigned_users"]}, "op=listUnassignedUsers&rol_id="+rolId);
      var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:userListCallback, argument:["assigned_users"]}, "op=listAssignedUsers&rol_id="+rolId);   
   }
   ...
   function assignUsers() {
	   ...
	   if (rolName != "Select rol") {
		   ...
		   var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:assignUsersCallback, argument:[rolId, rolName]}, "op=assignUsers&rol_id="+rolId+"&list="+list);
	   }
   }
   ...
   function recoverDataGroupsLists(rolId, rolName) {
      ...
      emptyList("unassigned_groups");
      emptyList("assigned_groups");
      var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:groupListCallback, argument:["unassigned_groups"]}, "op=listUnassignedGroups&rol_id="+rolId);
      var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:groupListCallback, argument:["assigned_groups"]}, "op=listAssignedGroups&rol_id="+rolId);   
   }
   ...
   function assignGroups() {
	   ...
	   if (rolName != "Select rol") {
		   ...
		   var transaction = YAHOO.util.Connect.asyncRequest('POST', "<?= npadmin_setting('NP-ADMIN', 'BASE_URL') ?>/public/ajax/rols.php", {success:assignGroupsCallback, argument:[rolId, rolName]}, "op=assignGroups&rol_id="+rolId+"&list="+list);
	   }
   }
