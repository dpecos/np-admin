...
$data = array (
   ...
   'Menu' => array(
      array('id' => 1, 'parent_id' => 0, 'order' => 0, 'text' => 'Main', 'url' => 'public/panels/mainPanel.php', 'panel_id' => 'mainPanel'),
      array('id' => 2, 'parent_id' => 0, 'order' => 1, 'text' => 'Management'),
      array('id' => 6, 'parent_id' => 0, 'order' => 2, 'text' => 'Configuration'),
      array('id' => 5, 'parent_id' => 2, 'order' => 0, 'text' => 'Menus', 'url' => 'public/panels/menuPanel.php', 'panel_id' => 'menuPanel'),
      array('id' => 9, 'parent_id' => 2, 'order' => 1, 'text' => 'Panels', 'url' => 'public/panels/panelPanel.php', 'panel_id' => 'panelPanel'),
      array('id' => 9, 'parent_id' => 2, 'order' => 2, 'text' => 'Applications', 'url' => 'public/panels/appsPanel.php', 'panel_id' => 'appsPanel'),
      array('id' => 8, 'parent_id' => 2, 'order' => 3),
      array('id' => 3, 'parent_id' => 2, 'order' => 4, 'text' => 'Users', 'url' => 'public/panels/userPanel.php', 'panel_id' => 'userPanel'),
      array('id' => 4, 'parent_id' => 2, 'order' => 5, 'text' => 'Groups', 'url' => 'public/panels/groupPanel.php', 'panel_id' => 'groupPanel'),
      array('id' => 11, 'parent_id' => 2, 'order' => 6, 'text' => 'Rols', 'url' => 'public/panels/rolPanel.php', 'panel_id' => 'rolPanel'),
      array('id' => 7, 'parent_id' => 6, 'order' => 0, 'text' => 'NP-Admin settings', 'url' => 'public/panels/settingsPanel.php', 'panel_id'=>'settingsPanel'),
      array('id' => 10, 'parent_id' => 6, 'order' => 1, 'url' => 'public/panels/phpInfoPanel.php', 'panel_id' => 'phpInfoPanel'),
   ),
   'MenuGroup' => array(),
   'MenuRol' => array(
