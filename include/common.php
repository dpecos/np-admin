...
if (file_exists($PWD."work/ddbb_config.php"))
   require_once($PWD."work/ddbb_config.php");
...
require_once($PWD."classes/Panel.sql.php");
require_once($PWD."classes/PanelGroup.sql.php");
